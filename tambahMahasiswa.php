                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <form action="src/process/createMahasiswa.php" method="post">
                                <div class="mb-2">
                                    <label for="name" class="form-label">NIM</label>
                                    <input type="text" class="form-control" id="nim" name="nim" aria-describedby="emailHelp" placeholder="Masukan NIM" required>
                                    <?php 
                                        if (isset($_GET['error'])) {
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="program_studi" name="program_studi" aria-describedby="emailHelp" placeholder="Program Studi" required>
                                </div>
                                <div class="mb-2">
                                    <label for="address" class="form-label">No WA</label>
                                    <input type="number" class="form-control" name="nomor_wa" id="nomor_wa" placeholder="Nomor WA" required>
                                </div>
                                <div class="mb-2">
